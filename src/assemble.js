...
html=html.replaceAll('__PAUSE_SCRIPT__', logo.script);
html=html.replaceAll('__PAUSE_SURFER__', logo.surfer);
html=html.replaceAll('__PAUSE_GAZER__', logo.gazer);
html=html.replaceAll('__PAUSE_FIGLIGHT__', logo.figLight);
html=html.replaceAll('__PAUSE_FIGNIGHT__', logo.figNight);
html=html.replaceAll('__PAUSE_SURFERNIGHT__', logo.surferNight);
html=html.replaceAll('__PAUSE_NIGHTTALL__', logo.nightTall);
